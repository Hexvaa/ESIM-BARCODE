...
function buildShareUrl(lpa: string, customDomain?: string, theme?: string, pkg?: { data?: string; duration?: string; region?: string }, logoShareUrl?: string): string {
  ...
  if (logoShareUrl) url += `&logo=${encodeURIComponent(logoShareUrl)}`
  return url
}
...
function ESIMCard({ esim, logoUrl, index, total, t, customDomain, logoShareUrl, themeMode, pkgData, pkgDuration, pkgRegion }: { esim: ESim; logoUrl: string | null; index: number; total: number; t: typeof DARK; customDomain?: string; logoShareUrl?: string; themeMode?: string; pkgData?: string; pkgDuration?: string; pkgRegion?: string }) {
  ...
  const handleCopyLink = () => {
    ...
    copyText(buildShareUrl(esim.lpa, customDomain, theme, { data: pkgData, duration: pkgDuration, region: pkgRegion }, logoShareUrl))
    setLinkCopied(true)
