...
function ESIMCard({ esim, logoUrl, index, total, t, customDomain, logoShareUrl, themeMode }: { esim: ESim; logoUrl: string | null; index: number; total: number; t: typeof DARK; customDomain?: string; logoShareUrl?: string; themeMode?: string }) {
